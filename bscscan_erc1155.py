...
logging.basicConfig(filename='log/bscscan_erc1155.log', level=logging.INFO,format='%(asctime)s,%(msecs)d %(name)s %(levelname)s %(message)s')
...
def add_database(data_json):
    ...
    table_id = "agile-axe-380803.transaction_mint.bsc1155"
